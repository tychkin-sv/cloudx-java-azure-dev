...
import io.swagger.processor.OrderProcessor;
...
public class StoreApiController implements StoreApi {
    ...
    public ResponseEntity<Order> placeOrder(
        ...
        if (acceptType != null && contentType != null && acceptType.contains("application/json")
            ...
            log.info("TSV body" + body.toString());
            ...
            try {
                ...
                String orderJSON = processor.process(order);
    ...
    public ResponseEntity<Order> getOrderById(
        ...
        if (acceptType != null && contentType != null && acceptType.contains("application/json")
            ...
            log.info(String.format("List products {}", products));
